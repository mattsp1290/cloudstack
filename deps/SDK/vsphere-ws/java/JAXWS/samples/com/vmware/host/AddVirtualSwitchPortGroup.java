...
public class AddVirtualSwitchPortGroup {
   ...
   private static void addVirtualSwitchPortGroup()
         throws InvalidPropertyFaultMsg, RuntimeFaultFaultMsg {
   ...
   private static void printUsage() {
      System.out
            .println("This sample is used to add a Virtual Machine Port Group to a vSwitch");
      System.out.println("\nParameters:");
      System.out
      ...
      System.out
            .println("vswitchid        [required] : Name of the VSwitch to add portgroup to");
      System.out
      ...
      System.out
            .println("--vswitchid [mySwitch] --portgroupname [myportgroup] --hostname [hostname]");
   }
