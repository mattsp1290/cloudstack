...
namespace QueryMemoryOverhead
{
   public class QueryMemoryOverheadV25
   {
       ...
       public static void Main(String[] args)
       {
           ...
           ecb = AppUtil.ExtendedAppUtil.initialize("QueryMemoryOverheadV25"
       ...
       public void queryMemoryOverhead()
       {
           ...
           ManagedObjectReference hmor =
              ecb.getServiceUtilV25().GetDecendentMoRef(null, "HostSystem", hostname);
           ...
           if (hmor != null)
           {
               if (VersionUtil.isApiVersionSupported(supportedVersions, "2.5"))
               {
                   ...
                   DateTime dt = ecb.getServiceConnectionV25().Service.CurrentTime(ecb.getServiceConnectionV25().ServiceRef);
