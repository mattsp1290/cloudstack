...
namespace RecordSession
{
    class RecordSessionV25
    {
        ...
        public static void Main(string[] args)
        {
            ...
            ecb = AppUtil.ExtendedAppUtil.initialize("RecordSessionV25"
        ...
        public void RecordSessionOfVM()
        {
            try
            {
                ...
                ManagedObjectReference vmmor = ecb.getServiceUtilV25().GetDecendentMoRef(null, "VirtualMachine", ecb.get_option("vmname"));
                if (vmmor == null)
                {
