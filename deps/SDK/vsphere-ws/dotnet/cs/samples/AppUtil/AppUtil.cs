            ...
            while (i < args.Length)
            {
                ...
                if (args[i].StartsWith("--"))
                {
                    if (args.Length > i + 1)
                    {
                        ...
                        {
                            val = args[i + 1];
                            optsEntered.Add(opt.Substring(2), val);
                        }
                        else
                        {
                            optsEntered.Add(opt.Substring(2), null);
                        }
                    }
                    else
                    {
                    ...
                    if (password == null)
                    {
                        ...
                        try
                        {
                            ...
                            if (flagUserName == false)
                            {
                                ...
                                optsEntered.Add("username", username);
                                if (username == null)
                                {
                            ...
                            optsEntered.Add("password", password);
                        }
                        catch (Exception e)
                        {
                            // Do Noting
