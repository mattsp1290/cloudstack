...
namespace AppUtil
{
    public class ServiceUtilV25
    {
        private ExtendedAppUtil _ci;
        private SvcConnectionV25 _connection;

        public ServiceUtilV25()
        {
		}

      public void Init(ExtendedAppUtil ci) {
         _ci = ci;
         _connection = ci.getServiceConnectionV25();
      }
